        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-right navbar-top-links">
                    <li><a href="logout.php"><i class="fa fa-home fa-fw"></i> Logout</a></li>
                </ul>
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="mobilereg.php"><i class="fa fa-plus-square"></i>Adding Mobile Products</a>
                                    </li>
                                     <li>
                                        <a href="laptopreg.php"><i class="fa fa-plus-square"></i>Adding Laptop Products</a>
                                    </li>
                                    <li>
                                    <a href="viewlaptop.php"><i class="fa fa-search-plus"></i>Display Laptops</a>
                                    </li>
                                    <li>
                                    <a href="viewmobile.php"><i class="fa fa-search-plus"></i>Display Mobiles</a>
                                    </li>
                                     <li>
                                        <a href="totaluser.php"><i class="fa fa-user-circle-o"></i>Total User</a>
                                    </li>
                                     <li>
                                        <a class="active" href="users.php"><i class="fa fa-user-circle-o"></i>Total Admin Users</a>
                                    </li>
                                    <li>
                                        <a href="logout.php"><i class="fa fa-sign-out"></i>Login Page</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
